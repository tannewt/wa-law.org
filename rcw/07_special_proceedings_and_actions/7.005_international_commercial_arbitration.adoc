...
. Where a provision of this chapter, other than in RCW 7.05.360(1) and 7.05.430(2)(a), refers to a claim, it also applies to a counterclaim, and where it refers to a defense, it also applies to a defense to such counterclaim.
