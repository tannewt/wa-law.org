...
... Siting and constructing an on-site sewage disposal system as defined in RCW 70A.105.020 or a large on-site sewage system as defined in RCW 70A.115.010; or
...
. The department shall maintain a current list of all continuing education offerings by approved providers and ensure that the list is available to all licensees by request. The list must also be posted on the department's website.
