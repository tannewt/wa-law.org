...
. The department shall make detailed quarterly expenditure reports available to the transportation commission and to the public on the department's website using current department resources.
