...
.. "Affordable workforce housing" means housing for a single person, family, or unrelated persons living together whose income is at or below 80 percent of the median income, adjusted for household size, for the county where the housing is located; and
