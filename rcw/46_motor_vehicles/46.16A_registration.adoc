...
. A motor vehicle may not be registered, leased, rented, or sold for use in the state, starting with the model year as provided in RCW 70A.30.010, unless the vehicle:
