...
. [Empty]
.. The statute law committee, in its discretion, may publish the official copy of the session laws in a digital format on the code reviser or legislative website.
