...
. "Directory" means the directory to be created and published on a website by the attorney general pursuant to RCW 70.158.030(2).
...
.. The website will state that chapter 25, Laws of 2003 applies only to cigarettes including, pursuant to the definition of "cigarettes" in chapter 25, Laws of 2003, roll-your-own tobacco.
