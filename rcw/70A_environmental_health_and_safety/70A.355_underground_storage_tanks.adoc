...
. Local laws, ordinances, and resolutions pertaining to permits and fees for the use of underground storage tanks in street right-of-ways [rights-of-way] that were in existence prior to July 1, 1990, are not superseded or preempted.
