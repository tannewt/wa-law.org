...
.. Posting information describing where to recycle unwanted covered electronic products on its website;
...
. The department shall maintain on its website the following information:
...
. The department shall update this website information promptly upon receipt of a registration or a report.
