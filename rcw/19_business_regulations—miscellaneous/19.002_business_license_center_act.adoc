...
... Other information the department determines necessary to implement this section, including links to the licensing information, application, and instructions on the agency's website, if available.
