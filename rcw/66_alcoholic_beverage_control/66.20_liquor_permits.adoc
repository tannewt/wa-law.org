...
. Website requirements. When selling over the internet, all website pages associated with the sale of liquor must display the distillery or craft distillery licensee's registered trade name.
