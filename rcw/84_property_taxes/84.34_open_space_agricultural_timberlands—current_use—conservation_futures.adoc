...
. A county must notify the department after taking action under this section. The department must maintain a list of all counties that have provided this notice on their agency internet website.
