...
.. The number of overseas and service ballots issued by mail, email, website link, or facsimile;
...
.. The number of nonoverseas and nonservice ballots sent by email, website link, or facsimile;
