...
. [Empty]
.. The department may only approve an application submitted after June 30, 2019, for an interbasin water rights transfer after providing notice electronically to the board of county commissioners in the county of origin upon receipt of an application.
...
. The department must provide opportunity for public review of a proposed agreement before it is executed. The department must make proposed and executed watershed agreements and annual reports available on the department's internet website.
