...
. The reviser may remove annotations that have appeared in the published Revised Code of Washington for more than ten years, unless in a particular instance, it may be necessary to retain such to preserve the full intent of the law. Any annotations removed under this subsection shall be retained and available in the electronic copy of the Revised Code of Washington available on the code reviser website.
