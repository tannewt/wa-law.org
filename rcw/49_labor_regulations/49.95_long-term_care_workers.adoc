...
.. Post the comprehensive written policy in prominent locations at its place of business and in a prominent location on its website, such as an online payroll portal, if applicable. The covered employer must provide employees with a copy of the current policy within thirty days of the employee's date of hire, and at least once a year thereafter;
