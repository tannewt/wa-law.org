[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [HB 1153](/bill/2025-26/hb/1153/) > [Original Bill](/bill/2025-26/hb/1153/1/)

# HB 1153 - Urban forest management

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/House%20Bills/1153.pdf)
...
4. The department may use existing tools to assist communities to develop urban forestry management plans. Management plans may include, but not be limited to, the following elements:
    ...
    e. Achieving forest stand and tree diversity goals;
...
6. The department must establish optional model urban forestry ordinances and recommendations and deliver technical assistance and planning support to local jurisdictions that decide to utilize the model ordinances and recommendations. These model ordinances and recommendations must:
    ...
    d. Provide a tree selection and siting tool for use by local jurisdictions;
    ...
    f. Use the best available science to establish criteria for determining trees that, due to their size, environmental impact, or other significance are critical to retain during development;

    g. Prohibit a jurisdiction from requiring the retention outside of a critical area of any tree deemed by the jurisdiction to be significant, landmark, or otherwise of special import if such retention would affect a proposed development by:

        i. Reducing the maximum allowed density, number of allowed lots, or maximum allowed floor area ratio;

        ii. Precluding the construction of middle housing as defined in RCW 36.70A.030 or accessory dwelling units as defined in RCW 36.70A.696; or

        iii. Precluding the ability to establish any required access or utility connections to a lot; and

    h. Provide options for incentivizing developers to retain trees deemed by a jurisdiction to be significant, landmark, or otherwise of special import including, but not limited to, incentives related to:

        i. Increasing the allowed building density or height;

        ii. Reducing minimum required lot sizes;

        iii. Reducing or eliminating landscaping requirements; and

        iv. Reducing open space or setback requirements.

7. [Empty]

    a. Subject to the availability of amounts appropriated for this specific purpose, the department shall develop and administer a grant program to provide grants to cities and counties that adopt the model urban forestry ordinances produced by the department, for the purpose of implementing the requirements of the ordinances.
...
10. The department must encourage communities to include participation and input by vulnerable populations through community organizations and members of the public for urban and community forestry plans in the regions where they are based.
