[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [HB 2521](/bill/2025-26/hb/2521/) > [Original Bill](/bill/2025-26/hb/2521/1/)

# HB 2521 - Firearms background checks

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/House%20Bills/2521.pdf)
...
4. [Empty]
    ...
    a. The Washington state patrol shall require a dealer to charge each firearm purchaser or transferee a fee for performing background checks in connection with firearms transfers. The fee must be set at an amount reasonably calculated to cover the direct and indirect costs to the Washington state patrol incurred in administering the firearm background check program.  The Washington state patrol shall transmit the fees collected to the state treasurer for deposit in the state firearms background check system account created in RCW 43.43.590. It is the intent of the legislature that once the state firearm background check system is established, the fee established in this section will replace the fee required in RCW 9.41.090(7).
...
4. [Empty]
    ...
    a. The Washington state patrol shall require a dealer to charge each firearm purchaser or transferee a fee for performing background checks in connection with firearms transfers. The fee must be set at an amount reasonably calculated to cover the direct and indirect costs to the Washington state patrol incurred in administering the firearm background check program.  The Washington state patrol shall transmit the fees collected to the state treasurer for deposit in the state firearms background check system account created in RCW 43.43.590.
...
## Section 3
Section 1 of this act expires May 1, 2027.

## Section 4
Section 2 of this act takes effect May 1, 2027.
