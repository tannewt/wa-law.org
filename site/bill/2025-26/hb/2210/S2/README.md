[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [HB 2210](/bill/2025-26/hb/2210/) > [Second Substitute](/bill/2025-26/hb/2210/S2/)

# HB 2210 - Local government elections

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/House%20Bills/2210-S2.pdf)

## Section 1
1. The legislature finds that Washington has a proud tradition of promoting voter freedom and secure elections, which are the bedrock of our state democracy.

2. The legislature recognizes that federal voting rights protections are undergoing significant changes, and additional uncertainty is expected in the coming years. These developments may limit or alter the tools historically available to protect against vote dilution and ensure equitable access to the electoral process.

3. The legislature further finds that election methods such as ranked choice voting and proportional representation are used in other jurisdictions to reduce vote splitting, more accurately reflect voter preferences, and support effective and representative local governance.

4. Local governments require clear and flexible authority to select election methods that support fair representation, accountable leadership, and voter confidence. Current law does not provide sufficient clarity for jurisdictions interested in adopting alternative election systems.

5. To ensure that local jurisdictions retain effective and legally durable options during this period of threats known and unknown, the legislature intends to authorize local governments, for a period of six years, to choose to adopt ranked choice voting, proportional representation, or other approved election methods. Once a jurisdiction elects to use an authorized method within this six-year period, it may continue using that method thereafter. This authority is intended to provide practical tools, reduce litigation risk, and promote stable, transparent local governance while federal standards continue to evolve.

6. Nothing in this act diminishes existing rights or remedies under state law, including the Washington voting rights act, chapter 29A.92 RCW. This act is intended solely to expand the range of lawful election tools available to local jurisdictions during the specified decision period.

## Section 2
1. Except as provided in subsections (2) and (3) of this section, a county, city, town, school district, fire district, or port district may conduct its elections using ranked choice voting. A county, city, town, school district, fire district, or port district that opts to conduct its elections using ranked choice voting must adopt ranked choice voting before December 31, 2032. A county, city, town, school district, fire district, or port district that adopts ranked choice voting may, but need not, use ranked choice voting for all offices in an election.
...
4. An election using ranked choice voting must meet the following requirements:
    ...
    b. The county auditor must allow a voter to rank at least five candidates per office;
    ...
    f. The election must be one of two types of ranked choice voting elections. If the election is a single-winner contest, including an election in which multiple positions with the same name, district number, or title are dealt with as separate offices, the winner of each contest must be determined using the instant runoff voting method, as defined in this section. If the election is a multiwinner contest in which the positions are not dealt with as separate offices, the winners must be determined using the single transferable vote method, as defined in this section;
...
9. A jurisdiction that, by the effective date of this section, has adopted ranked choice voting may continue to use ranked choice voting, and the provisions of subsection (5) do not apply to that jurisdiction.
