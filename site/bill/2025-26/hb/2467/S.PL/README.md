...
4. [Empty]
    ...
    c. For the purposes of calculating the overall length of a fifth-wheel travel trailer, the measurement is the distance between the centermost point of the kingpin and the rearmost point of the vehicle, generally referred to as the rear bumper or rear cap.

5. For purposes of this section:

    a. "Fifth-wheel travel trailer" means a vehicle primarily designed for recreational camping or travel use that does not have its own motive power and is primarily mounted on or hitched within the bed of a pickup truck;

    b. "Kingpin" means a metal pin protruding from the bottom of the front of a fifth-wheel travel trailer that is designed to create a pivot point for steering, stability, and connecting the truck and fifth-wheel travel trailer.
