[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [HB 1834](/bill/2025-26/hb/1834/) > [Third Substitute](/bill/2025-26/hb/1834/S3/)

# HB 1834 - Online services/minors

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/House%20Bills/1834-S3.pdf)
...
4. "Minor," unless otherwise specified, means an individual under 18 years of age who is a resident of Washington state.
...
1. It shall be unlawful for the operator of an addictive internet-based service or application to provide an addictive feed to a user unless:
    ...
    a. Prior to July 1, 2027, the operator does not have actual knowledge that the user is a minor; or

    b. Commencing July 1, 2027, the operator has reasonably determined that the user is not a minor.
...
## Section 3
1. Prior to July 1, 2027, it shall be unlawful for an operator of an addictive internet-based service or application, between the hours of 12:00 a.m. and 6:00 a.m., in the user's local time zone, and between the hours of 8:00 a.m. and 3:00 p.m., from Monday through Friday from September through May in the user's local time zone, to send push notifications to a user if the operator has actual knowledge that the user is a minor unless the operator has obtained parental consent, verifiable to a reasonable level of certainty, to send those push notifications.

2. Commencing July 1, 2027, it shall be unlawful for an operator of an addictive internet-based service or application, between the hours of 12:00 a.m. and 6:00 a.m., in the user's local time zone, and between the hours of 8:00 a.m. and 3:00 p.m., from Monday through Friday from September through May in the user's local time zone, to send push notifications to a user whom the operator has not reasonably determined is not a minor unless the operator has obtained parental consent, verifiable to a reasonable level of certainty, to send push notifications during those time ranges or other time ranges specified by the parent.

3. Nothing in this section shall restrict the ability of an operator of an addictive internet-based service or application to send push notifications to a user regarding software updates, security alerts, or other information regarding the integrity or maintenance of the user's account.
...
## Section 7
An operator of an addictive internet-based service or application, or entity, service, or other third party who has acted on behalf of such an operator to determine a user's age, shall not use any personal information collected when determining a user's age or age range for any other purpose or retain that personal information, other than the user's age or age range, longer than necessary to determine the user's age or age range.
