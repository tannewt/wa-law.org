[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [HB 2500](/bill/2025-26/hb/2500/) > [Original Bill](/bill/2025-26/hb/2500/1/)

# HB 2500 - Transfers to charities

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/House%20Bills/2500.pdf)
...
2. The affidavit must include:
    ...
    d. A statement that the organization is a charitable organization as defined in this chapter;

    e. A request that the property be transferred or information released to the charitable organization;

    f. A statement that no other person has a superior right to the property; and

    g. A declaration under penalty of perjury that the information in the affidavit is true and correct.

3. The affidavit must be accompanied by:

    a. A copy of the organization's internal revenue service determination letter;

    b. A certificate of existence issued by the secretary of state;

    c. Verification of the decedent's death, such as a death certificate, a published notice of probate, proof of payment of the decedent's funeral expenses, a newspaper obituary article, or a published death notice;

    d. Evidence of the affiant's authority to act on behalf of the organization; and

    e. A completed internal revenue service form W-9 for the organization.
...
2. For purposes of this section, "personal identifying information" includes, but is not limited to:
    ...
    a. Social security numbers or driver's license numbers;
    ...
    g. Home phone numbers;

    h. Annual income, including child support;

        i. Value of personal assets and source of wealth;

    j. Credit checks;

    k. Criminal background checks;

    l. Marital status;

    m. Number of dependents; and

    n. Spouse's maiden name.
...
2. The court may award:
    ...
    c. A civil penalty between $500 and $10,000; and
