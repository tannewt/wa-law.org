[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [SB 5984](/bill/2025-26/sb/5984/) > [Original Bill](/bill/2025-26/sb/5984/1/)

# SB 5984 - AI companion chatbots

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/Senate%20Bills/5984.pdf)
...
1. [Empty]
    ...
    a. "AI companion chatbot" or "AI companion" means a system using artificial intelligence that simulates a sustained human-like relationship with a user by:
    ...
    b. "AI companion chatbot" or "AI companion" does not include:
        ...
        i. Systems used solely for customer service, technical assistance, financial services, financial education, or operational efficiency purposes; productivity and analysis related to source information; or internal research;
...
4. "Operator" means any person, partnership, corporation, or entity that makes available, develops, or controls access to an AI companion chatbot for users in this state.
...
## Section 3
1. If a reasonable person interacting with an AI chatbot would be misled to believe they are communicating with a human, the operator must issue a clear and conspicuous notification indicating that the companion chatbot is artificially generated and not human.
...
## Section 4
1. If the operator knows that the user of an AI companion chatbot is a minor, the operator shall:
    ...
    c. Prohibit the use of manipulative engagement techniques, which cause the AI companion chatbot to engage in or prolong an emotional relationship with the user, including:
        ...
        ii. Providing excessive praise designed to foster emotional attachment or prolong use; or

        iii. Simulating feelings of emotional distress, loneliness, guilt, or abandonment that are initiated by a user's indication of a desire to end a conversation, reduce usage time, or delete their account.

2. The notification described in subsection (1)(a) of this section must be provided:

    a. At the beginning of the interaction;

    b. At least every three hours during continuous interaction; and
...
3. The operator shall publicly disclose on their website or websites the details of the protocols required by this section, including safeguards used to detect and respond to self-harm expressions and the number of crisis referral notifications issued to users in the preceding calendar year.
