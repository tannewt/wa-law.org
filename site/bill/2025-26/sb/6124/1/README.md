[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [SB 6124](/bill/2025-26/sb/6124/) > [Original Bill](/bill/2025-26/sb/6124/1/)

# SB 6124 - Appliance afford. index

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/Senate%20Bills/6124.pdf)
...
1. The department of commerce must carry out a study and submit a summary report to the legislature by January 31, 2028, assessing the feasibility of developing an affordability index for appliances sold into Washington state. The study required under this section must, at a minimum, consider what criteria an appliance would be evaluated under in an affordability index, including, but not limited to:
    ...
    a. Ease of maintenance and servicing based on physical design and component accessibility;

    b. The availability of repair materials including replacement parts, service manuals, and the need for special tools or proprietary software;

    c. Estimated performance life with and without recommended routine maintenance;

    d. Estimated annual routine maintenance costs;

    e. Resistance to wear and tear;

    f. Duration of software support and reliance on software support;

    g. Use of renewable and recycled materials in appliance construction;

    h. End-of-life compostability or recyclability of major components; and

        i. Costs to dispose of or recycle the appliance and its associated parts.
...
3. The study must evaluate the following as it relates to the use of an affordability index:
    ...
    b. Feasibility of adapting existing appliance sustainability labeling standards for use in Washington;

    c. How the information in the affordability index will be generated, updated, and verified;

    d. Who will be responsible for management of the affordability index as well as estimated one-time and ongoing costs associated with maintenance of an affordability index;

    e. How information about the affordability index will be communicated to customers;

    f. Recommendations on how consumer feedback regarding appliance affordability and sustainability can be collected and how it may inform an affordability index;

    g. Recommendations to support manufacturer participation in the affordability index program including consideration of a rebate program.
...
4. In carrying out the study, the department of commerce or their designee must solicit input from stakeholders with expertise or lived experience in the following:
    ...
    a. Right to repair as it relates to appliances;

    b. Solid waste management;

    c. Consumer sustainability practices;

    d. Appliance manufacturing;

    e. Energy efficiency;

    f. Consumer protection;

    g. Appliance standards, including energy star programs;

    h. Washington state building code standards; and

        i. Low-income and historically disadvantaged populations.
