[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [SB 6047](/bill/2025-26/sb/6047/) > [Substitute Bill](/bill/2025-26/sb/6047/S/)

# SB 6047 - State capital projects

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/Senate%20Bills/6047-S.pdf)
...
6. A separate capital budget document or schedule shall be submitted
...
1. Capital budget documents or schedules submitted to the legislature as required by RCW 43.88.030 must contain the following:
    ...
    b. A statement setting forth the full-time equivalent staff for each agency assigned to capital projects, in a manner comparable to staff reporting for operating expenditures;

    c. A capital program consisting of proposed capital projects for the next biennium and the two biennia succeeding the next biennium consistent with the long-range facilities plan. Insomuch as is practical, and recognizing emergent needs, the capital program must reflect the priorities, projects, and spending levels proposed in previously submitted capital budget documents in order to provide a reliable long-range planning tool for the legislature and state agencies;

    d. A capital plan consisting of proposed capital spending for at least four biennia succeeding the next biennium;
...
2. The following definitions apply throughout this section and section 4 of this act unless the context clearly requires otherwise.
    ...
    a. "Capital project" means all phases of construction of a new facility, or significant, long-term renewal improvements or repairs to existing facilities, and may also include land or building acquisition and grants passed through to others for capital projects. "Capital project" does not include routine maintenance or operating expenditures.

    b. "Institutions of higher education" has the same meaning as in RCW 28B.77.070.

    c. "Major capital project" means any capital project in excess of $4,000,000 for institutions of higher education and $2,000,000 for all other agencies.

    d. "Minor works projects" means any capital project that does not meet the threshold for a major capital project and which meets the requirements set out in section 4 of this act.
...
2. [Empty]
    ...
    a. The legislature does not intend to reappropriate moneys for projects for which a contract has not been executed within four years from the date of original appropriation or for which appropriations have not been spent within six years of original appropriation:

        i. For grant programs and community projects appropriated from the state building construction account; or

        ii. For other programs for which the capital budget appropriations act specifies the appropriation is subject to the provisions of this section.
...
10. For purposes of this section and section 7 of this act, "total anticipated cost" means the sum of the anticipated cost of the predesign, design, and construction phases of the project.
...
1. Except as provided in subsection (3) of this section, agencies must complete a predesign for any state construction project with a total anticipated cost in excess of $10,000,000. The predesign must include, but not be limited to, the following elements:
    ...
    d. Utilization of a system of cost, quality, and performance standards to comparable major capital construction projects; and

    e. A requirement to incorporate value-engineering analysis and constructability review into the project schedule.
...
4. In deliberations related to submitting an exception under subsection (3) of this section, the office of financial management shall consider the following factors:
    ...
    e. Whether the requesting agency indicates that the project may not require some or all of the requirements in subsection (1) of this section due to a lack of complexity; and
...
2. By December of each odd-numbered year, the council shall outline the council's fiscal priorities under the ten-year plan that it must distribute to the institutions, the state board for community and technical colleges, the office of financial management, and the joint higher education committee.
    ...
    a. Capital budget outlines  shall be submitted to the office of financial management by August 15th of each even-numbered year, and shall include the prioritized ranking of the capital projects being requested, a description of each capital project, and the amount and fund source being requested.
