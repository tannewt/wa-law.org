[wa-law.org](/) > [bill](/bill/) > [2025-26](/bill/2025-26/) > [SB 5627](/bill/2025-26/sb/5627/) > [Original Bill](/bill/2025-26/sb/5627/1/)

# SB 5627 - Safe excavation

[Source](http://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bills/Senate%20Bills/5627.pdf)
...
5. "Emergency" means any condition constituting a clear and present danger to life, health, or property, or a customer service outage due to an unplanned utility outage that requires immediate action where an excavator or facility operator has a crew onsite or enroute.

6. "End user" means any utility customer or consumer of utility services or commodities provided by a facility operator. An "end user" does not include a person or entity that owns, operates, or maintains underground facilities in a public right-of-way.
...
30. "Design locating" means locating for planning purposes. "Design locating" does not include locating for excavation purposes.

31. "Force majeure" means: Natural disasters, including fire, flood, earthquake, windstorm, avalanche, mudslide, and other similar events; acts of war or civil unrest when an emergency has been declared by appropriate governmental officials; acts of civil or military authority; embargoes; epidemics; terrorist acts; riots; insurrections; explosions; and nuclear accidents.

32. "General contractor" has the same meaning as defined in RCW 18.27.010.

33. "Hard surface" means an area covered with asphalt, concrete, interlocking brick or block solid stone, wood, or any similar impervious or nonporous material on the surface of the ground.

34. "Positive response" means a notification from the owner or operator of the underground facility, or the owner's or operator's authorized locating contractor, to the one-number locator service confirming that the facility owner, operator, or contracted locator has completed marking or provided location information regarding unlocatable facilities in response to a notice.

35. "Safe and careful work methods" means methods of excavation, including pot holing, hand digging when practical, vacuum excavation methods, pneumatic hand tools, or other technical methods that may be developed.

36. "White lining" means the use of any white paint, flags, stakes, whiskers, or other locally accepted method that is distinguishable from the surrounding area. "White lining" also includes the use of geometric polygons when a request is received using an electronic mapping software.

37. "Work-to-begin date" means an identified date not less than two full business days and not more than 10 full business days, not including Saturdays, Sundays, legal local, state, or federal holidays, from the date notice is given to a one-number locator service.
...
1. The commission must establish a single statewide toll-free telephone number to be used for referring excavators to the appropriate one-number locator service. The one-number locator service shall maintain a web-based platform that provides the same services as the toll-free telephone number online. The web-based platform must meet the requirements outlined in RCW 19.122.030 (1) and (2). The web-based platform must be free of charge to those requesting location of underground facilities and operated in the same manner as the toll-free telephone number.
    ...
    a. The web-based platform, to be sufficient for electronic notice, must employ a digital mapping software that utilizes sufficiently accurate geographic data that permits the excavator to accurately place on an electronic map, markers designating the intended area(s) of excavation.

    b. The one-number locator service may permit multiple excavators on a single notice, so long as each excavator is provided with an individual and unique confirmation code.

    c. The one-number locator service must require that an excavator provide a work-to-begin date in the notice.

2. The commission, in consultation with the the entity administering the one-number locator service, must establish minimum standards and best management practices for one-number locator services.
...
## Section 4
1. Hazardous liquid and gas pipeline operators shall locate all underground facilities as required under Title 49 C.F.R. Secs. 195.442(c)(5) and 192.614(c)(5) as they existed on the effective date of this section, or such subsequent date as may be provided by the commission by rule, consistent with the purpose of this section.

2. Except as provided in subsection (1) of this section, if an operator does not visibly mark the location of unlocatable underground utilities or facilities, or marks a triangle, the operator shall provide information on the unlocatable facilities approximate location, if known, and size, type of facility, and any other known information that enables the excavator to use safe and careful work methods to determine the approximate location of the facility. The facility operator shall provide the excavator with contact information for a facility representative who is not a contract locator who can answer questions regarding the unlocatable facility during the course of excavation.

3. After January 1, 2027, facility operators shall make all underground facilities installed after the effective date of this section locatable underground facilities.

4. Facility operators shall add location information for unlocatable underground facilities, to a facility operator-maintained mapping database within 30 calendar days of the date the facility operator acquires location information for each previously unlocatable underground facility.

5. After December 31, 2025, facility operators shall maintain maps, drawings, diagrams, or other records illustrating the location of all underground facilities that the facility operator abandons or designates as out-of-service. If within the white-lined area in a notice, the facility operator shall indicate the presence of these facilities by marking the location of the abandoned or out-of-service facilities with an "A" in a circle and include the size and type of facility.

## Section 5
1. [Empty]

    a. Unless exempted under RCW 19.122.031, before commencing any excavation, an excavator must mark the boundary of the excavation area with white . An excavator shall provide the work-to-begin date in the notice provided to the one-number locator service. Physical marking of the boundary of excavation is not required when the excavator provides notice to a one-number locator service through a web-based platform, in accordance with subsection (2) of this section. Where notice is submitted using the web-based platform, any physical markings on the site take priority to the markings submitted using the online mapping software. Where reasonable, excavators and facility operators shall adopt the 20th version of the common ground alliance's best practices for locating, marking, and excavating methods published in 2024, or such subsequent versions as may be adopted by the commission by rule, consistent with the purposes of this section.

    b. If boundary marking required by (a) of this subsection is infeasible, an excavator must provide notice electronically to a one-number locator service using geographic mapping features as described in (a) of this subsection.

2. [Empty]

    a. An excavator must provide the notice required by subsection (1) of this section to a one-number locator service not less than two full business days and not more than 10 full business days before the scheduled work-to-begin date , unless otherwise agreed by the excavator and facility operators in writing. If an excavator intends to work at multiple sites or at a large project, the excavator must take reasonable steps to confer with facility operators to enable them to locate underground facilities reasonably in advance of the start of excavation for each phase of the work. If notice is provided through the web-based platform, such notice must contain electronic mapping of the boundary of excavation as defined in RCW 19.122.027(1)(a). Submission of notice electronically without sufficient geographic mapping is not notice under this chapter.

    b. A general contractor may provide the notice required by subsection (1) of this section on behalf of an excavator. A general contractor may list multiple excavators in the notice if the notice contains, for each excavator, the excavator's full legal name, phone number, physical address, and company name, if applicable. The excavator engaging in excavation is liable for all costs and penalties resulting from damage caused by excavation. The excavator engaging in excavation is liable for all costs and penalties that result from damage from excavation that occurred because of failure to follow the notice. If damage was the result of a flaw in the notice, the general contractor who submitted the notice is liable for all costs and penalties resulting from the damage.
...
11. Each facility operator shall provide to a one-number locator service directions on how a requestor may obtain, for design locating, information regarding the location of underground facilities. For the purpose of this subsection, a "requestor" is any person seeking the location of underground facilities for design locating. Facility operators may attach fees for design locating.
...
## Section 10
1. Any person who violates any provision of this chapter not amounting to a violation of RCW 19.122.055 is subject to a civil penalty of  not more than $5,000 for each  violation within a three-year period. All penalties recovered in such actions must be deposited in the damage prevention account created in RCW 19.122.160.

2. Any excavator who fails to give notice of planned excavation and damages a marked underground facility is liable for all costs incurred in repairing or relocating the facility and any penalties assessed under this chapter.
