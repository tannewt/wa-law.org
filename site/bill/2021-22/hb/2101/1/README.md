...
[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/House%20Bills/2101.pdf)
## Section 1
> This section modifies existing section [90.66.065](/rcw/90_water_rights—environment/90.66_family_farm_water_act.md). Here is the [modified chapter](rcw/90_water_rights—environment/90.66_family_farm_water_act.md) for context.
...
## Section 2
> This section modifies existing section [36.70A.360](/rcw/36_counties/36.070A_growth_management—planning_by_selected_counties_and_cities.md). Here is the [modified chapter](rcw/36_counties/36.070A_growth_management—planning_by_selected_counties_and_cities.md) for context.
