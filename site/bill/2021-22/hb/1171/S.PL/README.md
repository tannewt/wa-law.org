# Substitute House Bill 1171 as Recommended by Civil Rights & Judiciary - as passed by the Legislature

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/House%20Passed%20Legislature/1171-S.PL.pdf)
## Section 1
...
## Section 2
> This section modifies existing section [6.27.140](/rcw/06_enforcement_of_judgments/6.27_garnishment.md). Here is the [modified chapter](rcw/06_enforcement_of_judgments/6.27_garnishment.md) for context.
...
## Section 3
> This section modifies existing section [6.27.150](/rcw/06_enforcement_of_judgments/6.27_garnishment.md). Here is the [modified chapter](rcw/06_enforcement_of_judgments/6.27_garnishment.md) for context.
...
## Section 4
> This section modifies existing section [6.27.330](/rcw/06_enforcement_of_judgments/6.27_garnishment.md). Here is the [modified chapter](rcw/06_enforcement_of_judgments/6.27_garnishment.md) for context.
...
## Section 5
> This section modifies existing section [26.18.020](/rcw/26_domestic_relations/26.18_child_support_enforcement.md). Here is the [modified chapter](rcw/26_domestic_relations/26.18_child_support_enforcement.md) for context.
...
## Section 6
> This section modifies existing section [26.18.080](/rcw/26_domestic_relations/26.18_child_support_enforcement.md). Here is the [modified chapter](rcw/26_domestic_relations/26.18_child_support_enforcement.md) for context.
...
## Section 7
> This section modifies existing section [26.18.090](/rcw/26_domestic_relations/26.18_child_support_enforcement.md). Here is the [modified chapter](rcw/26_domestic_relations/26.18_child_support_enforcement.md) for context.
...
## Section 9
> This section modifies existing section [26.18.110](/rcw/26_domestic_relations/26.18_child_support_enforcement.md). Here is the [modified chapter](rcw/26_domestic_relations/26.18_child_support_enforcement.md) for context.
...
## Section 10
> This section modifies existing section [26.18.130](/rcw/26_domestic_relations/26.18_child_support_enforcement.md). Here is the [modified chapter](rcw/26_domestic_relations/26.18_child_support_enforcement.md) for context.
...
## Section 11
> This section modifies existing section [26.18.140](/rcw/26_domestic_relations/26.18_child_support_enforcement.md). Here is the [modified chapter](rcw/26_domestic_relations/26.18_child_support_enforcement.md) for context.
...
## Section 12
> This section modifies existing section [26.23.010](/rcw/26_domestic_relations/26.23_state_support_registry.md). Here is the [modified chapter](rcw/26_domestic_relations/26.23_state_support_registry.md) for context.
...
## Section 13
> This section modifies existing section [26.23.050](/rcw/26_domestic_relations/26.23_state_support_registry.md). Here is the [modified chapter](rcw/26_domestic_relations/26.23_state_support_registry.md) for context.
...
## Section 15
> This section modifies existing section [26.23.060](/rcw/26_domestic_relations/26.23_state_support_registry.md). Here is the [modified chapter](rcw/26_domestic_relations/26.23_state_support_registry.md) for context.
...
## Section 17
> This section modifies existing section [74.20A.080](/rcw/74_public_assistance/74.20A_support_of_dependent_children—alternative_method—1971_act.md). Here is the [modified chapter](rcw/74_public_assistance/74.20A_support_of_dependent_children—alternative_method—1971_act.md) for context.
...
## Section 18
> This section modifies existing section [74.20A.240](/rcw/74_public_assistance/74.20A_support_of_dependent_children—alternative_method—1971_act.md). Here is the [modified chapter](rcw/74_public_assistance/74.20A_support_of_dependent_children—alternative_method—1971_act.md) for context.
...
2. **An assignment of earnings presented by the secretary in accordance with this section must include income withholding forms adopted and required by the United States department of health and human services.**
...
## Section 19
> This section modifies existing section [74.20A.350](/rcw/74_public_assistance/74.20A_support_of_dependent_children—alternative_method—1971_act.md). Here is the [modified chapter](rcw/74_public_assistance/74.20A_support_of_dependent_children—alternative_method—1971_act.md) for context.
...
1. The division of child support may issue a notice of noncompliance to any person, firm, entity, or agency of state or federal government that the division believes is not complying with:
    ...
    a. **An income withholding order** issued under chapter 26.23 RCW;
    ...
    e. An information request issued by the division of child support, or the agency or firm providing child support enforcement for another state under Title IV-D of the federal social security act, to an employer or entity required to respond to such requests under RCW 74.20A.360;

    f. The duty to report newly hired employees imposed by RCW 26.23.040; or
...
4. The division of child support may impose fines of up to one hundred dollars per occurrence for:
    ...
    c. A business, employer, or payroll processor's noncompliance with the duty to remit withheld funds by electronic means imposed by RCW 26.23.065. The division of child support may not impose fines for failure to comply with this requirement unless it has provided the person, firm, entity, or agency of state or federal government with written warning:
        ...
        ii. Explaining the potential for fines for failure to remit withheld payments by electronic means when required under RCW 26.23.065; and
...
8. The liability asserted by the division of child support in the notice of noncompliance becomes final and collectible on the twenty-first day after the date of service, unless within that time the person, firm, entity, or agency of state or federal government:
...
9. The notice of noncompliance shall contain:
...
14. The division of child support may enter agreements for the repayment of obligations under this section. Agreements may:
