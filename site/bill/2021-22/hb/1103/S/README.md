...
1. [Empty]
    ...
    a. Beginning July 1, 2021, an awarding authority must encourage, but may not require, the selected firm for a contract for a covered project to submit the following data for each covered product used prior to the final construction retainage payment:
