...
## **82.04.XXX - TBD**
**
1. This chapter does not apply to a start-up business during the first 24 months of operation of the start-up business.

2. A start-up business must file an application, in a form and manner required by the department, before taking the exemption under this section.

3. For purposes of this section, "start-up business" means a business that: (a) Has an annual revenue of less than $500,000; (b) has fewer than 50 employees; and (c) obtained or was required to obtain a registration certificate under RCW 82.32.030.
