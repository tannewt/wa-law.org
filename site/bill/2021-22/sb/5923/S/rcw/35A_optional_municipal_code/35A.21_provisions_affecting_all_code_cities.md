...
## **35A.21.XXX - TBD**
**
A code city is not required to adopt or enforce, or may waive, any state or local building codes applicable to temporary shelters. For purposes of this section, "temporary shelter" means a use sited in a new or existing structure or modular structure that provides temporary sleeping and shelter accommodations for persons experiencing homelessness; such use may include common areas for food preparation, showers, or other commonly used facilities.
