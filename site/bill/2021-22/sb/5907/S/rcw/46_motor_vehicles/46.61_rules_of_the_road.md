...
2. The driver of any motor vehicle, upon approaching an emergency or work zone, shall:
    ...
    c. If changing lanes or moving away would be unsafe, proceed with due caution and **continue to** reduce the speed of the vehicle to at least **10** miles per hour below the posted speed limit**, except for when the posted speed limit exceeds 60 miles per hour or more, then reduce the speed of the vehicle to 50 miles per hour or lower**.
