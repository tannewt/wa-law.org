[wa-law.org](/) > [bill](/bill/) > [2023-24](/bill/2023-24/) > [SB 5802](/bill/2023-24/sb/5802/) > [Substitute Bill](/bill/2023-24/sb/5802/S/)

# SB 5802 - Nursing rate calculation

[Source](http://lawfilesext.leg.wa.gov/biennium/2023-24/Pdf/Bills/Senate%20Bills/5802-S.pdf)
...
1. The legislature recognizes that staff and resources needed to adequately care for individuals with cognitive or behavioral impairments is not limited to support for activities of daily living. Therefore, the department shall:
    ...
    a. ‑Develop a method for applying case mix to the rate. This method should be informed by minimum data set data collected by the centers for medicare and medicaid services;

    b. Develop and implement rules to outline what data is used and how it is implemented; and

    c. Subject to the availability of amounts appropriated for this specific purpose, employ the method to adjust rates of individual facilities for case mix changes.
