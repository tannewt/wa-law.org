...
[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/House%20Bills/1514.pdf)
## Section 1
...
## Section 2
> This section modifies existing section [46.74.010](/rcw/46_motor_vehicles/46.74_ride_sharing.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.74_ride_sharing.md) for context.
...
2. **"Ride sharing" means a carpool or vanpool arrangement whereby one or more groups not exceeding 15 persons each including the drivers, and not fewer than three persons including the drivers are transported in a passenger motor vehicle with a gross vehicle weight not exceeding 10,000 pounds.**
...
## Section 3
> This section modifies existing section [46.74.030](/rcw/46_motor_vehicles/46.74_ride_sharing.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.74_ride_sharing.md) for context.
...
## Section 6
> This section modifies existing section [82.08.0287](/rcw/82_excise_taxes/82.08_retail_sales_tax.md). Here is the [modified chapter](rcw/82_excise_taxes/82.08_retail_sales_tax.md) for context.
...
## Section 10
> This section modifies existing section [82.70.010](/rcw/82_excise_taxes/82.70_commute_trip_reduction_incentives.md). Here is the [modified chapter](rcw/82_excise_taxes/82.70_commute_trip_reduction_incentives.md) for context.
...
4. "Ride sharing" means the same as " ride sharing" as defined in RCW 46.74.010, including ride sharing on Washington state ferries.
