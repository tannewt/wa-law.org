# Engrossed Second Substitute House Bill 1815 as Recommended by Transportation - as passed by the Legislature

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/House%20Passed%20Legislature/1815-S2.PL.pdf)
## Section 1
...
## Section 2
1. The Washington State University shall convene a catalytic converter theft work group to study and provide options and recommendations related to reducing catalytic converter theft in Washington state.
...
3. The work group's study shall include, but is not limited to, the following:
    ...
    e. Options and opportunities to reduce costs to victims of catalytic converter theft; and

    f. A review of the effectiveness of the grant and training program created under RCW 36.28A.240.
...
## Section 6
> This section adds a new section to an existing chapter [46.80](/rcw/46_motor_vehicles/46.80_vehicle_wreckers.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.80_vehicle_wreckers.md) for context.
...
## Section 7
> This section modifies existing section [46.80.080](/rcw/46_motor_vehicles/46.80_vehicle_wreckers.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.80_vehicle_wreckers.md) for context.
