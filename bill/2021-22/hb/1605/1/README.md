...
## Section 4
> This section modifies existing section [47.05.030](/rcw/47_public_highways_and_transportation/47.05_priority_programming_for_highway_development.md). Here is the [modified chapter](rcw/47_public_highways_and_transportation/47.05_priority_programming_for_highway_development.md) for context.
...
2. The preservation program consists of those investments necessary to preserve the existing state highway system and to restore **and improve** existing safety features, giving consideration to lowest life-cycle costing. **This program includes responsibility for providing safety measures for high risk areas of unintentional lane departure that are likely to lead to serious injury or death.**
