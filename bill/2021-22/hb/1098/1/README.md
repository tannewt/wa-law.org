...
[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/House%20Bills/1098.pdf)
## Section 1
...
## Section 8
> This section modifies existing section [50.20.020](/rcw/50_unemployment_compensation/50.20_benefits_and_claims.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.20_benefits_and_claims.md) for context.

1. No week shall be counted as a waiting period week

**if benefits have been paid for that week, the individual was otherwise eligible for benefits, and it occurs within the benefit year which includes the week with respect to which the individual claims payment of benefits.**

2. **If RCW 50.20.010(1)(d) is waived, subsection (1) of this section is waived**.


## Section 10
> This section modifies existing section [50.20.100](/rcw/50_unemployment_compensation/50.20_benefits_and_claims.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.20_benefits_and_claims.md) for context.
...
## Section 11
> This section modifies existing section [50.20.118](/rcw/50_unemployment_compensation/50.20_benefits_and_claims.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.20_benefits_and_claims.md) for context.
...
## Section 12
> This section modifies existing section [50.20.120](/rcw/50_unemployment_compensation/50.20_benefits_and_claims.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.20_benefits_and_claims.md) for context.
...
## Section 13
> This section modifies existing section [50.20.140](/rcw/50_unemployment_compensation/50.20_benefits_and_claims.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.20_benefits_and_claims.md) for context.
...
## Section 14
> This section modifies existing section [50.24.014](/rcw/50_unemployment_compensation/50.24_contributions_by_employers.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.24_contributions_by_employers.md) for context.
...
Upon approval of an individual's training benefits plan submitted in accordance with RCW 50.22.155(2), an individual is considered enrolled in training, and regular benefits beginning with the week of approval shall not be charged to the experience rating account of any contribution paying employer.
    ...
    j. **Benefits paid for all weeks starting with the week ending March 28, 2020, and ending with the week ending May 2, 2020, shall not be charged to the experience rating account of any contribution paying employer.**
...
## Section 17
> This section modifies existing section [50.29.026](/rcw/50_unemployment_compensation/50.29_employer_experience_rating.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.29_employer_experience_rating.md) for context.
...
## Section 18
> This section modifies existing section [50.29.027](/rcw/50_unemployment_compensation/50.29_employer_experience_rating.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.29_employer_experience_rating.md) for context.

1. For the rate year **beginning** 1985 **until rate year 2021**, a benefit ratio shall be computed for each qualified employer by dividing the total amount of benefits charged to the account of the employer during the forty-eight consecutive months immediately preceding the computation date by the taxable payrolls of the employer for the same forty-eight month period as reported to the department by the cut-off dates. The division shall be carried to the sixth decimal place with the remaining fraction, if any, disregarded.

2. **For the rate year 2022 and each rate year thereafter, a benefit ratio shall be computed for each qualified employer by dividing the total amount of benefits charged to the account of the employer during the 60 consecutive months immediately preceding the computation date by the taxable payrolls of the employer for the same 60-month period as reported to the department by the cut-off dates. The division shall be carried to the sixth decimal place with the remaining fraction, if any, disregarded.**


## Section 19
> This section modifies existing section [50.29.041](/rcw/50_unemployment_compensation/50.29_employer_experience_rating.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.29_employer_experience_rating.md) for context.
...
## Section 20
> This section modifies existing section [50.29.062](/rcw/50_unemployment_compensation/50.29_employer_experience_rating.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.29_employer_experience_rating.md) for context.
...
## Section 21
> This section modifies existing section [50.29.063](/rcw/50_unemployment_compensation/50.29_employer_experience_rating.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.29_employer_experience_rating.md) for context.
...
## Section 22
> This section modifies existing section [50.44.060](/rcw/50_unemployment_compensation/50.44_special_coverage_provisions.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.44_special_coverage_provisions.md) for context.
...
(B) For any organization which did not pay wages throughout the four calendar quarters of the preceding calendar year, such percentage of its payroll during such year as the commissioner shall determine.
    ...
    e. [Empty]
        ...
        i. **Benefits paid during the one week waiting period when the one week waiting period is paid or reimbursed by the federal government shall not be billed.**
...
## Section 23
> This section modifies existing section [50.60.020](/rcw/50_unemployment_compensation/50.60_shared_work_compensation_plans—benefits.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.60_shared_work_compensation_plans—benefits.md) for context.
...
## Section 24
> This section modifies existing section [50.60.110](/rcw/50_unemployment_compensation/50.60_shared_work_compensation_plans—benefits.md). Here is the [modified chapter](rcw/50_unemployment_compensation/50.60_shared_work_compensation_plans—benefits.md) for context.
