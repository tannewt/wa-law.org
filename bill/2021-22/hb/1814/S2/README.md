# Second Substitute House Bill 1814 as Recommended by Finance

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/House%20Bills/1814-S2.pdf)
## Section 1
...
(A) Has a direct current nameplate capacity that is greater than 12 kilowatts but no greater than 1,000 kilowatts;
...
(F) Sales tax.
    ...
    q. "Retail electric customer" has the same meaning as in RCW 80.60.010.

    r. "Subscriber" means a retail electric customer of an electric utility who owns or is the beneficiary of one or more units of a community solar project directly interconnected with that same utility.

    s. "Subscription" means an agreement between a subscriber and the administrator of a community solar project.
...
5. [Empty]
    ...
    a. In addition to the one-time low-income community solar incentive payment under subsection (2) of this section, a participating utility must also provide the following compensation for the generation of electricity from the certified project:
        ...
        ii. For all other community solar projects for which the administrator is not a utility, compensation must be determined and paid to the retail electric customer according to a written agreement between the retail electric customer and the utility.
...
9. To obtain certification for the one-time community solar incentive payment provided under this section, a project administrator must submit to the Washington State University extension energy program an application, including, at a minimum:
    ...
    i. A copy of the executed agreement describing how benefits will be determined and distributed from the retail electric customer to the administrator if the administrator and the retail electric customer are not the same. The Washington State University extension energy program must review the executed agreement to determine that benefits are being fairly determined and that there is an adequate plan for distributing the benefits; and
...
3. **In order to receive certification for the incentive payment provided under section 5 of this act beginning July 1, 2022, a community solar project must meet the following requirements:**
    ...
    b. **The community solar project must have a direct current nameplate capacity that is greater than 12 kilowatts but no greater than 1,000 kilowatts, and must have at least two subscribers or one low-income service provider subscriber;**
