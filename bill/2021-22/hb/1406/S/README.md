# Substitute House Bill 1406 as Recommended by Finance

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Xml/Bills/House%20Bills/1406-S.xml)
## Section 1
...
(b)(i) A spouse or state registered domestic partner may petition the department, on a form and in a format as required by the department, for permission to file a separate return. The department must grant the petition only if it finds that good cause exists for allowing the petitioner to file a separate return.
...
(6)(a) Notwithstanding any other provision of this section, an individual seeking relief under this section may not seek relief for taxes on wealth derived from disqualified assets. For the purposes of this subsection, "disqualified asset" means any asset or right to an asset transferred between spouses or state registered domestic partners required to jointly file a return under this chapter if the principal purpose of the transfer was the avoidance of tax.
...
## Section 9
> This section modifies existing section [82.32.160](/rcw/82_excise_taxes/82.32_general_administrative_provisions.md). Here is the [modified chapter](rcw/82_excise_taxes/82.32_general_administrative_provisions.md) for context.
