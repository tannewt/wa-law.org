...
## Section 2
> This section modifies existing section [13.34.315](/rcw/13_juvenile_courts_and_juvenile_offenders/13.34_juvenile_court_act—dependency_and_termination_of_parent-child_relationship.md). Here is the [modified chapter](rcw/13_juvenile_courts_and_juvenile_offenders/13.34_juvenile_court_act—dependency_and_termination_of_parent-child_relationship.md) for context.
...
2. **The department shall provide payment for medical, dental, and behavioral health care for children in the custody of the department that is:**

    a. **Not approved by the integrated managed health and behavioral health care program required for foster children under RCW 74.09.860; and**

    b. **Approved in writing by a department caseworker assigned to work with the child.**
