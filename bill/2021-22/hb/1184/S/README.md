# Substitute House Bill 1184 as Recommended by Local Government
...
2. At a minimum, the rules required under subsection (1) of this section must address the following:
    ...
    h. Any conflicts the rules adopted in this section have with the department of ecology's municipal stormwater general permit criteria and guidance manuals on stormwater for eastern and western Washington. The rules must provide property owners who capture or reuse water in conformance with the requirements set forth in these rules to be able to adjust the water amounts used in calculations related to stormwater runoff and stormwater detention that is required to be mitigated by existing construction project permitting requirements. Any calculations of the amount of water that a property owner or construction permit holder must make to address runoff from impervious services must reduce the amount of rainwater considered to be stormwater when it is captured to be used for alternative nonpotable end uses in buildings and projects.
