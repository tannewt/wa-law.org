...
2. [Empty]
    ...
    a. **Any emergency order issued by a local health officer in response to a proclaimed state of emergency must be narrowly tailored to the emergency and use the least restrictive means necessary to accomplish a compelling government interest.**
