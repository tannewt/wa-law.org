...
## Section 7
> This section modifies existing section [7.60.150](/rcw/07_special_proceedings_and_actions/7.060_receivers.md). Here is the [modified chapter](rcw/07_special_proceedings_and_actions/7.060_receivers.md) for context.
...
## Section 8
> This section modifies existing section [7.80.120](/rcw/07_special_proceedings_and_actions/7.080_civil_infractions.md). Here is the [modified chapter](rcw/07_special_proceedings_and_actions/7.080_civil_infractions.md) for context.
...
## Section 9
> This section modifies existing section [8.25.280](/rcw/08_eminent_domain/8.25_additional_provisions_applicable_to_eminent_domain_proceedings.md). Here is the [modified chapter](rcw/08_eminent_domain/8.25_additional_provisions_applicable_to_eminent_domain_proceedings.md) for context.
...
## Section 10
> This section modifies existing section [15.58.180](/rcw/15_agriculture_and_marketing/15.058_washington_pesticide_control_act.md). Here is the [modified chapter](rcw/15_agriculture_and_marketing/15.058_washington_pesticide_control_act.md) for context.
...
## Section 11
> This section modifies existing section [15.66.017](/rcw/15_agriculture_and_marketing/15.066_washington_state_agricultural_commodity_commissions.md). Here is the [modified chapter](rcw/15_agriculture_and_marketing/15.066_washington_state_agricultural_commodity_commissions.md) for context.
...
## Section 13
> This section modifies existing section [15.115.020](/rcw/15_agriculture_and_marketing/15.115_washington_grain_commission.md). Here is the [modified chapter](rcw/15_agriculture_and_marketing/15.115_washington_grain_commission.md) for context.
...
13. Chapter 20.01 RCW, agricultural productscommission merchants, dealers, brokers, buyers, agents;
...
## Section 15
> This section modifies existing section [18.106.010](/rcw/18_businesses_and_professions/18.106_plumbers.md). Here is the [modified chapter](rcw/18_businesses_and_professions/18.106_plumbers.md) for context.
...
## Section 16
> This section modifies existing section [18.210.130](/rcw/18_businesses_and_professions/18.210_on-site_wastewater_treatment_systems—designer_licensing.md). Here is the [modified chapter](rcw/18_businesses_and_professions/18.210_on-site_wastewater_treatment_systems—designer_licensing.md) for context.
...
## Section 17
> This section modifies existing section [19.27.080](/rcw/19_business_regulations—miscellaneous/19.027_state_building_code.md). Here is the [modified chapter](rcw/19_business_regulations—miscellaneous/19.027_state_building_code.md) for context.
...
The building code council shall adopt rules that permit the use of substitutes approved under RCW **70A.45.080** and that do not require the use of substitutes that are restricted under RCW **70A.45.080**.


## Section 19
> This section modifies existing section [19.27A.210](/rcw/19_business_regulations—miscellaneous/19.027A_energy-related_building_standards.md). Here is the [modified chapter](rcw/19_business_regulations—miscellaneous/19.027A_energy-related_building_standards.md) for context.
...
7. The building owner of a covered commercial building must report the building owner's compliance with the standard to the department in accordance with the schedule established under subsection (8) of this section and every five years thereafter. For each reporting date, the building owner must submit documentation to demonstrate that:
    ...
    c. The covered commercial building is exempt from the standard by demonstrating that the building meets one of the following criteria:
        ...
        iii. The sum of the buildings gross floor area minus unconditioned and semiconditioned spaces, as defined in the Washington state energy code, is less than fifty thousand square feet;
...
## Section 20
> This section modifies existing section [19.405.090](/rcw/19_business_regulations—miscellaneous/19.405_washington_clean_energy_transformation_act.md). Here is the [modified chapter](rcw/19_business_regulations—miscellaneous/19.405_washington_clean_energy_transformation_act.md) for context.
...
## Section 21
> This section modifies existing section [28B.10.926](/rcw/28B_higher_education/28B.010_colleges_and_universities_generally.md). Here is the [modified chapter](rcw/28B_higher_education/28B.010_colleges_and_universities_generally.md) for context.

1. Following the inspection required under RCW 28B.10.925 and prior to transferring ownership of an institution-owned vessel, the institution of higher education shall obtain the following from the transferee:
...
2. [Empty]
    ...
    a. The institution of higher education shall remove any containers or other materials that are not fixed to the vessel and contain hazardous substances, as defined under RCW **70A.305.020**.
...
## Section 22
> This section modifies existing section [28B.130.010](/rcw/28B_higher_education/28B.130_transportation_demand_management_programs.md). Here is the [modified chapter](rcw/28B_higher_education/28B.130_transportation_demand_management_programs.md) for context.
...
## Section 23
> This section modifies existing section [34.05.272](/rcw/34_administrative_law/34.05_administrative_procedure_act.md). Here is the [modified chapter](rcw/34_administrative_law/34.05_administrative_procedure_act.md) for context.
...
2. [Empty]
    ...
    b. On the agency's web site, the department of ecology must identify and categorize each source of information that is relied upon in the form of a bibliography, citation list, or similar list of sources. The categories in (c) of this subsection do not imply or infer any hierarchy or level of quality.
...
## Section 24
> This section modifies existing section [35A.56.010](/rcw/35A_optional_municipal_code/35A.56_local_service_districts.md). Here is the [modified chapter](rcw/35A_optional_municipal_code/35A.56_local_service_districts.md) for context.
...
## Section 25
> This section modifies existing section [36.32.265](/rcw/36_counties/36.032_county_commissioners.md). Here is the [modified chapter](rcw/36_counties/36.032_county_commissioners.md) for context.
...
## Section 26
> This section modifies existing section [39.04.175](/rcw/39_public_contracts_and_indebtedness/39.004_public_works.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.004_public_works.md) for context.

This chapter does not apply to the selection of persons or entities to construct or develop water pollution control facilities or to provide water pollution control services under RCW **70A.140.040** or the selection of persons or entities to construct or develop solid waste handling facilities or to provide solid waste handling services under RCW 35.21.156 or under RCW 36.58.090.


## Section 27
> This section modifies existing section [39.26.265](/rcw/39_public_contracts_and_indebtedness/39.026_procurement_of_goods_and_services.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.026_procurement_of_goods_and_services.md) for context.
...
## Section 28
> This section modifies existing section [39.26.310](/rcw/39_public_contracts_and_indebtedness/39.026_procurement_of_goods_and_services.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.026_procurement_of_goods_and_services.md) for context.
...
## Section 29
> This section modifies existing section [39.34.190](/rcw/39_public_contracts_and_indebtedness/39.034_interlocal_cooperation_act.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.034_interlocal_cooperation_act.md) for context.
...
## Section 30
> This section modifies existing section [43.01.225](/rcw/43_state_government—executive/43.001_state_officers—general_provisions.md). Here is the [modified chapter](rcw/43_state_government—executive/43.001_state_officers—general_provisions.md) for context.
...
## Section 31
> This section modifies existing section [43.01.230](/rcw/43_state_government—executive/43.001_state_officers—general_provisions.md). Here is the [modified chapter](rcw/43_state_government—executive/43.001_state_officers—general_provisions.md) for context.
...
## Section 32
> This section modifies existing section [43.01.240](/rcw/43_state_government—executive/43.001_state_officers—general_provisions.md). Here is the [modified chapter](rcw/43_state_government—executive/43.001_state_officers—general_provisions.md) for context.
...
## Section 33
> This section modifies existing section [43.19.623](/rcw/43_state_government—executive/43.019_department_of_enterprise_services.md). Here is the [modified chapter](rcw/43_state_government—executive/43.019_department_of_enterprise_services.md) for context.

Pursuant to policies and regulations promulgated by the office of financial management, an elected state officer or delegate or a state agency director or delegate may permit an employee to commute in a state-owned or leased vehicle if such travel is on official business, as determined in accordance with RCW **43.19.622**, and is determined to be economical and advantageous to the state, or as part of a commute trip reduction program as required by RCW **70A.15.4100**.


## Section 34
> This section modifies existing section [43.19.637](/rcw/43_state_government—executive/43.019_department_of_enterprise_services.md). Here is the [modified chapter](rcw/43_state_government—executive/43.019_department_of_enterprise_services.md) for context.
...
5. [Empty]
    ...
    a. Weight classes are established by the following motor vehicle types:
...
## Section 35
> This section modifies existing section [43.19.800](/rcw/43_state_government—executive/43.019_department_of_enterprise_services.md). Here is the [modified chapter](rcw/43_state_government—executive/43.019_department_of_enterprise_services.md) for context.
...
## Section 38
> This section modifies existing section [43.20.065](/rcw/43_state_government—executive/43.020_state_board_of_health.md). Here is the [modified chapter](rcw/43_state_government—executive/43.020_state_board_of_health.md) for context.
...
## Section 39
> This section modifies existing section [43.21K.010](/rcw/43_state_government—executive/43.021K_environmental_excellence_program_agreements.md). Here is the [modified chapter](rcw/43_state_government—executive/43.021K_environmental_excellence_program_agreements.md) for context.
...
## Section 40
> This section modifies existing section [43.21K.020](/rcw/43_state_government—executive/43.021K_environmental_excellence_program_agreements.md). Here is the [modified chapter](rcw/43_state_government—executive/43.021K_environmental_excellence_program_agreements.md) for context.
...
## Section 41
> This section modifies existing section [43.21K.030](/rcw/43_state_government—executive/43.021K_environmental_excellence_program_agreements.md). Here is the [modified chapter](rcw/43_state_government—executive/43.021K_environmental_excellence_program_agreements.md) for context.
...
## Section 42
> This section modifies existing section [43.30.570](/rcw/43_state_government—executive/43.030_department_of_natural_resources.md). Here is the [modified chapter](rcw/43_state_government—executive/43.030_department_of_natural_resources.md) for context.
...
## Section 43
> This section modifies existing section [43.42.070](/rcw/43_state_government—executive/43.042_office_of_regulatory_assistance.md). Here is the [modified chapter](rcw/43_state_government—executive/43.042_office_of_regulatory_assistance.md) for context.
...
## Section 44
> This section modifies existing section [43.70.080](/rcw/43_state_government—executive/43.070_department_of_health.md). Here is the [modified chapter](rcw/43_state_government—executive/43.070_department_of_health.md) for context.
...
## Section 45
> This section modifies existing section [43.70.660](/rcw/43_state_government—executive/43.070_department_of_health.md). Here is the [modified chapter](rcw/43_state_government—executive/43.070_department_of_health.md) for context.

1. The legislature authorizes the secretary to establish and maintain a product safety education campaign to promote greater awareness of products designed to be used by infants and children that:
...
## Section 46
> This section modifies existing section [43.83.350](/rcw/43_state_government—executive/43.083_capital_improvements.md). Here is the [modified chapter](rcw/43_state_government—executive/43.083_capital_improvements.md) for context.
...
## Section 47
> This section modifies existing section [43.131.421](/rcw/43_state_government—executive/43.131_washington_sunset_act_of_1977.md). Here is the [modified chapter](rcw/43_state_government—executive/43.131_washington_sunset_act_of_1977.md) for context.

The mercury-containing lights product stewardship program as established under chapter **70A.505** RCW is terminated July 1, 2025, as provided in RCW 43.131.422.


## Section 48
> This section modifies existing section [43.131.422](/rcw/43_state_government—executive/43.131_washington_sunset_act_of_1977.md). Here is the [modified chapter](rcw/43_state_government—executive/43.131_washington_sunset_act_of_1977.md) for context.

The following acts or parts of acts, as now existing or hereafter amended, are each repealed, effective July 1, 2026:

1. RCW **70A.505.010** (FindingsPurpose) and 2010 c 130 s 1;

2. RCW **70A.505.020** (Definitions) and 2014 c 119 s 2 & 2010 c 130 s 2;

3. RCW **70A.505.030** (Product stewardship program) and 2014 c 119 s 3 & 2010 c 130 s 3;

4. RCW **70A.505.040** (Submission of proposed product stewardship plansDepartment to establish rulesPublic reviewPlan updateAnnual report) and 2017 c 254 s 2, 2014 c 119 s 4, & 2010 c 130 s 4;

5. RCW **70A.505.050** (Financing the mercury-containing light recycling program) and 2017 c 254 s 1, 2014 c 119 s 5, & 2010 c 130 s 5;

6. RCW **70A.505.060** (Collection and management of mercury) and 2010 c 130 s 6;

7. RCW **70A.505.070** (Collectors of unwanted mercury-containing lightsDuties) and 2010 c 130 s 7;

8. RCW **70A.505.090** (Producers must participate in an approved product stewardship program) and 2010 c 130 s 9;

9. RCW **70A.505.100** (Written warningPenaltyAppeal) and 2010 c 130 s 10;

10. RCW **70A.505.110** (Department's web site to list producers participating in product stewardship planRequired participation in a product stewardship planWritten warningPenaltyRulesExemptions) and 2010 c 130 s 11;

11. RCW **70A.505.120** (Product stewardship programs account) and 2017 c 254 s 3 & 2010 c 130 s 13;

12. RCW **70A.505.130** (Adoption of rulesReport to the legislatureInvitation to entities to comment on issuesEstimate of statewide recycling rate for mercury-containing lightsMercury vapor barrier packaging) and 2010 c 130 s 14;

13. RCW **70A.505.140** (Application of chapter to the Washington utilities and transportation commission) and 2010 c 130 s 15;

14. RCW **70A.505.150** (Application of chapter to entities regulated under chapter **70A.300** RCW) and 2010 c 130 s 16;

15. RCW **70A.505.900** (Chapter liberally construed) and 2010 c 130 s 17;

16. RCW **70A.505.901** (Severability2010 c 130) and 2010 c 130 s 21; and

17. RCW **70A.505.160** and 2014 c 119 s 6.
...
## Section 51
> This section modifies existing section [46.37.470](/rcw/46_motor_vehicles/46.37_vehicle_lighting_and_other_equipment.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.37_vehicle_lighting_and_other_equipment.md) for context.
...
## Section 52
> This section modifies existing section [46.55.230](/rcw/46_motor_vehicles/46.55_towing_and_impoundment.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.55_towing_and_impoundment.md) for context.
...
## Section 53
> This section modifies existing section [46.80.020](/rcw/46_motor_vehicles/46.80_vehicle_wreckers.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.80_vehicle_wreckers.md) for context.
...
## Section 54
> This section modifies existing section [47.01.475](/rcw/47_public_highways_and_transportation/47.01_department_of_transportation.md). Here is the [modified chapter](rcw/47_public_highways_and_transportation/47.01_department_of_transportation.md) for context.
...
## Section 55
> This section modifies existing section [47.28.220](/rcw/47_public_highways_and_transportation/47.28_construction_and_maintenance_of_highways.md). Here is the [modified chapter](rcw/47_public_highways_and_transportation/47.28_construction_and_maintenance_of_highways.md) for context.
...
## Section 56
> This section modifies existing section [49.17.270](/rcw/49_labor_regulations/49.17_washington_industrial_safety_and_health_act.md). Here is the [modified chapter](rcw/49_labor_regulations/49.17_washington_industrial_safety_and_health_act.md) for context.
...
## Section 57
> This section modifies existing section [49.70.175](/rcw/49_labor_regulations/49.70_worker_and_community_right_to_know_act.md). Here is the [modified chapter](rcw/49_labor_regulations/49.70_worker_and_community_right_to_know_act.md) for context.
...
## Section 58
> This section modifies existing section [52.12.150](/rcw/52_fire_protection_districts/52.12_powers—burning_permits.md). Here is the [modified chapter](rcw/52_fire_protection_districts/52.12_powers—burning_permits.md) for context.
...
## Section 59
> This section modifies existing section [53.08.470](/rcw/53_port_districts/53.08_powers.md). Here is the [modified chapter](rcw/53_port_districts/53.08_powers.md) for context.
...
## Section 60
> This section modifies existing section [54.04.092](/rcw/54_public_utility_districts/54.04_general_provisions.md). Here is the [modified chapter](rcw/54_public_utility_districts/54.04_general_provisions.md) for context.
...
## Section 61
> This section modifies existing section [57.08.017](/rcw/57_water-sewer_districts/57.08_powers.md). Here is the [modified chapter](rcw/57_water-sewer_districts/57.08_powers.md) for context.
...
## Section 62
> This section modifies existing section [64.44.010](/rcw/64_real_property_and_conveyances/64.44_contaminated_properties.md). Here is the [modified chapter](rcw/64_real_property_and_conveyances/64.44_contaminated_properties.md) for context.
...
## Section 63
> This section modifies existing section [69.07.170](/rcw/69_food_drugs_cosmetics_and_poisons/69.07_washington_food_processing_act.md). Here is the [modified chapter](rcw/69_food_drugs_cosmetics_and_poisons/69.07_washington_food_processing_act.md) for context.
...
## Section 64
> This section modifies existing section [69.48.060](/rcw/69_food_drugs_cosmetics_and_poisons/69.48_drug_take-back_program.md). Here is the [modified chapter](rcw/69_food_drugs_cosmetics_and_poisons/69.48_drug_take-back_program.md) for context.
...
## Section 65
> This section modifies existing section [69.50.511](/rcw/69_food_drugs_cosmetics_and_poisons/69.50_uniform_controlled_substances_act.md). Here is the [modified chapter](rcw/69_food_drugs_cosmetics_and_poisons/69.50_uniform_controlled_substances_act.md) for context.
...
## Section 66
> This section modifies existing section [69.55.020](/rcw/69_food_drugs_cosmetics_and_poisons/69.55_ammonia.md). Here is the [modified chapter](rcw/69_food_drugs_cosmetics_and_poisons/69.55_ammonia.md) for context.
...
## Section 67
> This section modifies existing section [70.79.090](/rcw/70_public_health_and_safety/70.079_boilers_and_unfired_pressure_vessels.md). Here is the [modified chapter](rcw/70_public_health_and_safety/70.079_boilers_and_unfired_pressure_vessels.md) for context.
...
## Section 68
> This section modifies existing section [70.290.050](/rcw/70_public_health_and_safety/70.290_washington_vaccine_association.md). Here is the [modified chapter](rcw/70_public_health_and_safety/70.290_washington_vaccine_association.md) for context.
...
2. In selecting vaccines to purchase, the following factors should be strongly considered by the committee: Patient safety and clinical efficacy, public health and purchaser value, compliance with RCW **70A.230.120**, patient and provider choice, and stability of vaccine supply.


## Section 70
> This section modifies existing section [70A.45.090](/rcw/70A_environmental_health_and_safety/70A.045_limiting_greenhouse_gas_emissions.md). Here is the [modified chapter](rcw/70A_environmental_health_and_safety/70A.045_limiting_greenhouse_gas_emissions.md) for context.
...
## Section 71
> This section modifies existing section [70A.45.100](/rcw/70A_environmental_health_and_safety/70A.045_limiting_greenhouse_gas_emissions.md). Here is the [modified chapter](rcw/70A_environmental_health_and_safety/70A.045_limiting_greenhouse_gas_emissions.md) for context.
...
## Section 73
> This section modifies existing section [70A.325.130](/rcw/70A_environmental_health_and_safety/70A.325_underground_petroleum_storage_tanks.md). Here is the [modified chapter](rcw/70A_environmental_health_and_safety/70A.325_underground_petroleum_storage_tanks.md) for context.
...
## Section 74
> This section modifies existing section [70.330.010](/rcw/70_public_health_and_safety/70.330_diabetes—planning_and_reports.md). Here is the [modified chapter](rcw/70_public_health_and_safety/70.330_diabetes—planning_and_reports.md) for context.
...
## Section 76
> This section modifies existing section [70A.445.020](/rcw/70A_environmental_health_and_safety/70A.445_recreational_water_vessels—antifouling_paints.md). Here is the [modified chapter](rcw/70A_environmental_health_and_safety/70A.445_recreational_water_vessels—antifouling_paints.md) for context.
...
## Section 79
> This section modifies existing section [76.04.205](/rcw/76_forests_and_forest_products/76.04_forest_protection.md). Here is the [modified chapter](rcw/76_forests_and_forest_products/76.04_forest_protection.md) for context.
...
## Section 80
> This section modifies existing section [76.09.905](/rcw/76_forests_and_forest_products/76.09_forest_practices.md). Here is the [modified chapter](rcw/76_forests_and_forest_products/76.09_forest_practices.md) for context.
...
## Section 81
> This section modifies existing section [77.12.734](/rcw/77_fish_and_wildlife/77.012_powers_and_duties.md). Here is the [modified chapter](rcw/77_fish_and_wildlife/77.012_powers_and_duties.md) for context.

1. Following the inspection required under RCW 77.12.732 and prior to transferring ownership of a department-owned vessel, the department shall obtain the following from the transferee:
...
## Section 83
> This section modifies existing section [78.44.050](/rcw/78_mines_minerals_and_petroleum/78.44_surface_mining.md). Here is the [modified chapter](rcw/78_mines_minerals_and_petroleum/78.44_surface_mining.md) for context.
...
## Section 84
> This section modifies existing section [78.56.020](/rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md). Here is the [modified chapter](rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md) for context.
...
## Section 85
> This section modifies existing section [78.56.040](/rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md). Here is the [modified chapter](rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md) for context.
...
## Section 86
> This section modifies existing section [78.56.100](/rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md). Here is the [modified chapter](rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md) for context.
...
1. In order to receive a waste discharge permit from the department of ecology pursuant to the requirements of chapter 90.48 RCW or in order to operate a metals mining and milling tailing facility, an applicant proposing a metals mining and milling operation regulated under this chapter must meet the following additional requirements:
    ...
    d. An operator or applicant for a metals mining and milling operation must complete a voluntary reduction plan in accordance with RCW **70A.214.110**.
...
## Section 87
> This section modifies existing section [78.56.150](/rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md). Here is the [modified chapter](rcw/78_mines_minerals_and_petroleum/78.56_metals_mining_and_milling_operations.md) for context.
...
## Section 88
> This section modifies existing section [79.100.030](/rcw/79_public_lands/79.100_derelict_vessels.md). Here is the [modified chapter](rcw/79_public_lands/79.100_derelict_vessels.md) for context.
...
## Section 89
> This section modifies existing section [79.100.050](/rcw/79_public_lands/79.100_derelict_vessels.md). Here is the [modified chapter](rcw/79_public_lands/79.100_derelict_vessels.md) for context.
...
## Section 90
> This section modifies existing section [79A.05.050](/rcw/79A_public_recreational_lands/79A.05_parks_and_recreation_commission.md). Here is the [modified chapter](rcw/79A_public_recreational_lands/79A.05_parks_and_recreation_commission.md) for context.
...
## Section 91
> This section modifies existing section [79A.05.189](/rcw/79A_public_recreational_lands/79A.05_parks_and_recreation_commission.md). Here is the [modified chapter](rcw/79A_public_recreational_lands/79A.05_parks_and_recreation_commission.md) for context.
...
## Section 92
> This section modifies existing section [80.01.300](/rcw/80_public_utilities/80.01_utilities_and_transportation_commission.md). Here is the [modified chapter](rcw/80_public_utilities/80.01_utilities_and_transportation_commission.md) for context.
...
## Section 94
> This section modifies existing section [80.04.110](/rcw/80_public_utilities/80.04_regulations—general.md). Here is the [modified chapter](rcw/80_public_utilities/80.04_regulations—general.md) for context.

1. [Empty]

    a. Complaint may be made by the commission of its own motion or by any person or corporation, chamber of commerce, board of trade, or any commercial, mercantile, agricultural or manufacturing society, or any body politic or municipal corporation, or by the public counsel section of the office of the attorney general, or its successor, by petition or complaint in writing, setting forth any act or thing done or omitted to be done by any public service corporation in violation, or claimed to be in violation, of any provision of this title, Title 81 RCW, or of any order or rule of the commission.
...
## Section 95
> This section modifies existing section [80.04.180](/rcw/80_public_utilities/80.04_regulations—general.md). Here is the [modified chapter](rcw/80_public_utilities/80.04_regulations—general.md) for context.
...
## Section 96
> This section modifies existing section [80.28.030](/rcw/80_public_utilities/80.28_gas_electrical_and_water_companies.md). Here is the [modified chapter](rcw/80_public_utilities/80.28_gas_electrical_and_water_companies.md) for context.
...
## Section 98
> This section modifies existing section [80.70.010](/rcw/80_public_utilities/80.70_carbon_dioxide_mitigation.md). Here is the [modified chapter](rcw/80_public_utilities/80.70_carbon_dioxide_mitigation.md) for context.
...
## Section 99
> This section modifies existing section [80.70.040](/rcw/80_public_utilities/80.70_carbon_dioxide_mitigation.md). Here is the [modified chapter](rcw/80_public_utilities/80.70_carbon_dioxide_mitigation.md) for context.
...
3. Mitigation projects must be fully in place within a reasonable time after the start of commercial operation. Failure to implement an approved mitigation plan is subject to enforcement under chapter 80.50 or **70A.15** RCW.
...
## Section 100
> This section modifies existing section [81.04.010](/rcw/81_transportation/81.004_regulations—general.md). Here is the [modified chapter](rcw/81_transportation/81.004_regulations—general.md) for context.
...
8. "Street railroad company" includes every corporation, company, association, joint stock association, partnership, and person, their lessees, trustees, or receivers appointed by any court whatsoever, and every city or town, owning, controlling, operating, or managing any street railroad or any cars or other equipment used thereon or in connection therewith within this state.
...
## Section 101
> This section modifies existing section [81.88.160](/rcw/81_transportation/81.088_gas_and_hazardous_liquid_pipelines.md). Here is the [modified chapter](rcw/81_transportation/81.088_gas_and_hazardous_liquid_pipelines.md) for context.
...
## Section 102
> This section modifies existing section [90.44.105](/rcw/90_water_rights—environment/90.44_regulation_of_public_groundwaters.md). Here is the [modified chapter](rcw/90_water_rights—environment/90.44_regulation_of_public_groundwaters.md) for context.
...
## Section 104
> This section modifies existing section [11.130.040](/rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md). Here is the [modified chapter](rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md) for context.
...
## Section 105
> This section modifies existing section [11.130.245](/rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md). Here is the [modified chapter](rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md) for context.
...
## Section 106
> This section modifies existing section [11.130.670](/rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md). Here is the [modified chapter](rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md) for context.
...
## Section 107
> This section modifies existing section [11.130.910](/rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md). Here is the [modified chapter](rcw/11_probate_and_trust_law/11.130_uniform_guardianship_conservatorship_and_other_protective_arrangements_act.md) for context.
