...
[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Xml/Bills/Senate%20Bills/5527.xml)
## Section 1
> This section modifies existing section [48.18.140](/rcw/48_insurance/48.018_the_insurance_contract.md). Here is the [modified chapter](rcw/48_insurance/48.018_the_insurance_contract.md) for context.
...
5. [Empty]
    ...
    a. **The declarations page on residential policies must include a listing of all sublimits of coverage within the insurance policy, including any endorsements, and show either the amount of coverage, the percentage of coverage, or both, that is being limited below the overall policy coverage limits.**

    b. **For the purposes of this subsection (5) only:**

        i. **"Residential policies" include all homeowners, renters, condominium, mobile home, and manufactured home noncommercial coverage.**

        ii. **"Sublimit" means a limitation in an insurance policy on the amount of coverage available to cover a specific type of loss that is lower than the overall coverage amount.**

    c. **The entire declarations page must be delivered to the insured at every policy renewal.**

6. This section shall not apply to surety insurance contracts.
