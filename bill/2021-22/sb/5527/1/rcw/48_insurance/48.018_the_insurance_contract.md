...
5.**(a) The declarations page on residential policies must include a listing of all sublimits of coverage within the insurance policy, including any endorsements, and show either the amount of coverage, the percentage of coverage, or both, that is being limited below the overall policy coverage limits.**
