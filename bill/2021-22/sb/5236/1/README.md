...
[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Xml/Bills/Senate%20Bills/5236.xml)
## Section 1
> This section modifies existing section [70.38.111](/rcw/70_public_health_and_safety/70.038_health_planning_and_development.md). Here is the [modified chapter](rcw/70_public_health_and_safety/70.038_health_planning_and_development.md) for context.
...
## Section 2
> This section modifies existing section [70.38.260](/rcw/70_public_health_and_safety/70.038_health_planning_and_development.md). Here is the [modified chapter](rcw/70_public_health_and_safety/70.038_health_planning_and_development.md) for context.
...
3. [Empty]
    ...
    a. Until June 30, **2023**, a psychiatric hospital licensed as an establishment under chapter 71.12 RCW is exempt from certificate of need requirements for the one-time addition of up to thirty new psychiatric beds**devoted solely for 90-day and 180-day civil commitment services and for new voluntary psychiatric beds or involuntary for patients on a 72 hour detention or 14-day civil commitment order, if the hospital** makes a commitment to maintain a payer mix of at least fifty percent medicare and medicaid based on a calculation using patient days for a period of five consecutive years after the beds are made available for use by patients, if it demonstrates to the satisfaction of the department:
