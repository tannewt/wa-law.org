...
## Section 2
> This section modifies existing section [19.405.050](/rcw/19_business_regulations—miscellaneous/19.405_washington_clean_energy_transformation_act.md). Here is the [modified chapter](rcw/19_business_regulations—miscellaneous/19.405_washington_clean_energy_transformation_act.md) for context.
...
## Section 3
> This section modifies existing section [80.80.050](/rcw/80_public_utilities/80.80_greenhouse_gas_emissions—baseload_electric_generation_performance_standard.md). Here is the [modified chapter](rcw/80_public_utilities/80.80_greenhouse_gas_emissions—baseload_electric_generation_performance_standard.md) for context.
