...
## **47.06A.XXX - TBD**
**
The freight mobility strategic investment board shall establish a railroad crossing grant program. The board shall develop a prioritization process to make awards to cities and counties with projects that eliminate at grade highway-rail crossings. Application to federal grant programs to secure matching funds must be one factor to be considered as part of the prioritization process, but the primary criteria must center on improving safety and expediting the movement of vehicles by eliminating highway-rail crossing at grade with a grade separation.
