# Second Substitute Senate Bill 5793 - Session Law Chapter 245 Year 2022 as Recommended by Ways & Means

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/Session%20Laws/Senate/5793-S2.SL.pdf)
## Section 1
...
## Section 3
> This section adds a new section to an existing chapter [43.03](/rcw/43_state_government—executive/43.003_salaries_and_expenses.md). Here is the [modified chapter](rcw/43_state_government—executive/43.003_salaries_and_expenses.md) for context.

1. By December 1, 2022, the office of equity shall develop uniform equity-driven guidelines for agencies on the issuance of stipends and allowances authorized under RCW 43.03.220 to provide for consistent application of the law. In developing the guidelines, the office of equity shall consult with stakeholders including, but not limited to, state agencies and impacted communities. The guidelines for providing allowances must include the reasonable allowances as prescribed by the office of financial management under RCW 43.03.050.

2. Agencies exercising their authority under RCW 43.03.220 to provide stipends or allowances to members of class one groups shall adhere to the guidelines established under subsection (1) of this section.


## Section 4
> This section modifies existing section [28A.300.802](/rcw/28A_common_school_provisions/28A.300_superintendent_of_public_instruction.md). Here is the [modified chapter](rcw/28A_common_school_provisions/28A.300_superintendent_of_public_instruction.md) for context.
...
## Section 5
> This section modifies existing section [43.03.050](/rcw/43_state_government—executive/43.003_salaries_and_expenses.md). Here is the [modified chapter](rcw/43_state_government—executive/43.003_salaries_and_expenses.md) for context.
...
## Section 6
> This section modifies existing section [43.03.060](/rcw/43_state_government—executive/43.003_salaries_and_expenses.md). Here is the [modified chapter](rcw/43_state_government—executive/43.003_salaries_and_expenses.md) for context.
