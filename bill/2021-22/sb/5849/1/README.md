...
4. [Empty]
    ...
    a. "Eligible investment project" means an investment project that is located, as of the date the application required by **section 6 of this act** is received by the department, in an eligible area as defined in subsection (3) of this section.
...
The department, with the assistance of the employment security department, must establish a list of qualifying counties effective July 1, 2010. The list of qualifying counties is effective for a twenty-four month period and must be updated **every 24 months as long as applications are accepted under section 6 of this act**.
...
2. The department must issue a sales and use tax deferral certificate for state and local sales and use taxes due under chapters 82.08, 82.12, and 82.14 RCW on each eligible investment project.
