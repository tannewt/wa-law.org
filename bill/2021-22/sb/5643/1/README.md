...
## Section 2
> This section adds a new section to an existing chapter [15.76](/rcw/15_agriculture_and_marketing/15.076_agricultural_fairs_youth_shows_exhibitions.md). Here is the [modified chapter](rcw/15_agriculture_and_marketing/15.076_agricultural_fairs_youth_shows_exhibitions.md) for context.
...
2. It is in the public interest to support youth participation in youth development programs, including youth development programs authorized in RCW 36.50.010. The legislature intends to appropriate funds to fulfill the enrollment fees owed to the programs by participants as an allocation under RCW 15.76.150.


## Section 3
> This section modifies existing section [36.50.010](/rcw/36_counties/36.050_farm_and_home_extension_work.md). Here is the [modified chapter](rcw/36_counties/36.050_farm_and_home_extension_work.md) for context.
