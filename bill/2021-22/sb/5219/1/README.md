...
(3)(a) The department shall adopt rules to implement a fee that will not exceed $200 per ton. The department may structure fees to lower fees for producers that achieve partial compliance.
...
(2)(a) Twenty-five percent of the expenditures from the account must be used for grants to owners or operators of material recovery facilities that process municipal solid wastes.
