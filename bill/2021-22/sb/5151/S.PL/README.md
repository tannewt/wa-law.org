# Substitute Senate Bill 5151 as Recommended by Ways & Means - as passed by the Legislature

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/Senate%20Passed%20Legislature/5151-S.PL.pdf)
## Section 1
...
## Section 7
> This section modifies existing section [43.216.087](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 8
> This section modifies existing section [43.216.089](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
4. [Empty]
    ...
    a. Beginning December 1, 2020, the department, in collaboration with the statewide child care resource and referral network, shall make available on its public web site, in a consumer-friendly format, the following elements:
...
## Section 9
> This section modifies existing section [43.216.250](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 11
> This section modifies existing section [43.216.260](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 12
> This section modifies existing section [43.216.271](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 13
> This section modifies existing section [43.216.280](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 14
> This section modifies existing section [43.216.305](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 15
> This section modifies existing section [43.216.325](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 16
> This section modifies existing section [43.216.340](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 17
> This section modifies existing section [43.216.360](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
5. That if the agency does not initiate the licensing process within thirty days of the date of the notice, the department will post on its web site that the agency is providing child care without a license.


## Section 18
> This section modifies existing section [43.216.395](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 20
> This section modifies existing section [43.216.530](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 21
> This section modifies existing section [43.216.650](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 22
> This section modifies existing section [43.216.660](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 23
> This section modifies existing section [43.216.685](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 24
> This section modifies existing section [43.216.687](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
## Section 25
> This section modifies existing section [43.216.689](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
3. The department may make available on a publicly accessible web site all inspection reports and notices of licensing actions, including the corrective measures required or taken, involving child day care centers**, outdoor nature-based child care providers,** and family day care providers.
...
## Section 27
> This section modifies existing section [43.216.700](/rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md). Here is the [modified chapter](rcw/43_state_government—executive/43.216_department_of_children_youth_and_families.md) for context.
...
7. [Empty]
    ...
    d. **A child-specific license does not confer upon the licensee a right to placement of a particular child, nor does it confer party status in any proceeding under chapter 13.34 RCW.**
