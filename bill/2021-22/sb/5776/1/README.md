...
[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Xml/Bills/Senate%20Bills/5776.xml)
## Section 1
...
2. The data system shall be managed by the department of health, which may:
    ...
    b. Enter into or adopt a memorandum of understanding with each contributing local government, state agency and department, or volunteer nongovernmental entity. Such memorandum must identify the confidentiality of the information and any conditions or restrictions on the use of the data or information.

3. The records and data collected and stored by the criminal justice integrated data system shall be exempt from disclosure as provided in RCW 42.56.240. The confidentiality of all records and data collected by the criminal justice integrated data system shall comply with applicable state and federal laws governing the privacy of records, data, and personal identifiable information.
...
2. In addition to the chair, the data oversight council shall consist of the following members or the member's designee:
    ...
    n. A representative from the office of public defense or a defense representative; and
