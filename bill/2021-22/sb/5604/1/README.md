...
1. Before award of a public works contract, a bidder must meet the following responsibility criteria to be considered a responsible bidder and qualified to be awarded a public works project. The bidder must:
    ...
    a. At the time of bid submittal, **be registered or licensed as may be required by the laws of this state including contractor registration in compliance with chapter 18.27 RCW, and contractor licensing in compliance with chapter 18.106 RCW**;
...
## Section 2
> This section modifies existing section [39.06.020](/rcw/39_public_contracts_and_indebtedness/39.006_public_works—registration_licensing_of_contractors.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.006_public_works—registration_licensing_of_contractors.md) for context.
...
## Section 3
> This section modifies existing section [39.12.050](/rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md) for context.
...
## Section 4
> This section modifies existing section [39.12.055](/rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md) for context.
...
2. Committed an infraction or violation under chapter 18.27 **or 18.106** RCW for performing work as an unregistered **or unlicensed** contractor; or
...
## Section 5
> This section modifies existing section [39.12.065](/rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md) for context.
...
## Section 6
> This section modifies existing section [39.12.100](/rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md). Here is the [modified chapter](rcw/39_public_contracts_and_indebtedness/39.012_prevailing_wages_on_public_works.md) for context.
...
7. On the effective date of the contract of service, if the nature of the work performed requires registration under chapter 18.27 RCW or licensure under chapter **18.106 or** 19.28 RCW, the individual has **the contractor registration and contractor licenses required by the laws of this state including** chapter**s** 18.27 **, 18.106, and** 19.28 RCW.
...
## Section 9
> This section modifies existing section [51.08.181](/rcw/51_industrial_insurance/51.08_definitions.md). Here is the [modified chapter](rcw/51_industrial_insurance/51.08_definitions.md) for context.
...
7. On the effective date of the contract of service, the individual has a valid contractor registration pursuant to chapter 18.27 RCW**, a plumbing contractor license pursuant to chapter 18.106 RCW,** or an electrical contractor license pursuant to chapter 19.28 RCW.


## Section 10
> This section modifies existing section [51.12.070](/rcw/51_industrial_insurance/51.12_employments_and_occupations_covered.md). Here is the [modified chapter](rcw/51_industrial_insurance/51.12_employments_and_occupations_covered.md) for context.
...
2. Nonemergency transportation brokers that operate as not-for-profit businesses are not liable for any premiums of a subcontractor if the provisions of subsection (1)(c) and (e) of this section are met throughout the term of the contract. For purposes of this section, nonemergency transportation brokers are those organizations or entities that contract with the state health care authority, or its successor, to arrange nonemergency transportation for qualified clients.


## Section 11
> This section modifies existing section [51.12.120](/rcw/51_industrial_insurance/51.12_employments_and_occupations_covered.md). Here is the [modified chapter](rcw/51_industrial_insurance/51.12_employments_and_occupations_covered.md) for context.
...
4. If a worker or beneficiary is entitled to compensation under this title by reason of an injury sustained in this state while in the employ of an employer who is domiciled in another state or province of Canada and the employer:
    ...
    b. Has filed a certificate under subsection (3)(a)(iii) of this section or (a) of this subsection (4):
        ...
        ii. The director shall send to such employer or his or her insurance carrier, by registered or certified mail to the address shown on such certificate, a true copy of any notice of claim or other process served on the director by the claimant in any proceeding brought to enforce rights under this title;
...
9. "Temporary and incidental" means work performed by Washington employers on jobs or at jobsites in another state for thirty or fewer consecutive or nonconsecutive full or partial days within a calendar year. Temporary and incidental days are considered on a per state basis.
...
## Section 12
> This section modifies existing section [51.16.070](/rcw/51_industrial_insurance/51.16_assessment_and_collection_of_premiums—payrolls_and_records.md). Here is the [modified chapter](rcw/51_industrial_insurance/51.16_assessment_and_collection_of_premiums—payrolls_and_records.md) for context.
...
## Section 13
> This section modifies existing section [51.48.022](/rcw/51_industrial_insurance/51.48_penalties.md). Here is the [modified chapter](rcw/51_industrial_insurance/51.48_penalties.md) for context.
