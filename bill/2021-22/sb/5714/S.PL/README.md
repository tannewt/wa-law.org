# Engrossed Substitute Senate Bill 5714 as Recommended by Environment, Energy & Technology - as passed by the Legislature

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/Senate%20Passed%20Legislature/5714-S.PL.pdf)
## Section 1
...
4. [Empty]
    ...
    a. "Initiation of construction" means the date that a building permit is issued under the building code adopted under RCW 19.27.031 for:
        ...
        ii. Construction of the eligible investment project, if the economic benefits of the deferral are passed to a lessee as provided in section 8 of this act; or

        iii. Tenant improvements for the eligible investment project, if the economic benefits of the deferral are passed to a lessee as provided in section 8 of this act.
...
## Section 6
1. Except as otherwise provided in this chapter, the recipient of the deferral under this chapter must receive a reduction of the amount of state and local sales and use tax to be repaid under this act as follows:
...
## Section 9
This section is the tax preference performance statement for the sales and use tax deferral program created in sections 4 and 7, chapter . . ., Laws of 2022 (sections 4 and 7 of this act). This performance statement is only intended to be used for subsequent evaluation of the tax preference. It is not intended to create a private right of action by any party or be used to determine eligibility for preferential tax treatment.
