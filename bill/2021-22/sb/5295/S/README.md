# Substitute Senate Bill 5295 as Recommended by Environment, Energy & Technology
...
5. **"Fourth rate year" means the consecutive 12-month period, if any, that commences on the third anniversary of the rate effective date.**

6. **"Future rate year" means any of an initial rate year, a second rate year, a third rate year, or a fourth rate year.**

7. **"Highly impacted community" has the same meaning as defined in RCW 19.405.020.**

8. **"Historic test year" means the 12-month period that reflects the actual results of operations consistent with commission precedent.**

9. **"Initial rate year" means the consecutive 12-month period that commences on the rate effective date.**

10. **"Multiyear rate plan" means a period of no more than 48 months for which a gas or electrical company proposes to develop and apply rates and consists of the initial rate year, the second rate year and, if applicable, a third rate year, and a fourth rate year.**

11. **"Operating expense" means expenditures of a gas or electrical company associated with the direct or regular activity of supplying gas or electricity and related services to customers including, but not limited to, salaries, wages, cost of maintenance and operation, materials, fuel, supplies, insurance, and all other items normally included under recognized accounting practices, but does not include allowances for depreciation in the value of physical property.**

12. **"Rate effective date" means the date on which rates approved by the commission pursuant to this chapter first become effective.**

13. **"Second rate year" means the consecutive 12-month period that commences on the first anniversary of the rate effective date.**
