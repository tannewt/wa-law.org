# Substitute Senate Bill 5728 as Recommended by Ways & Means - as passed by the Legislature

[Source](http://lawfilesext.leg.wa.gov/biennium/2021-22/Pdf/Bills/Senate%20Passed%20Legislature/5728-S.PL.pdf)
## Section 1
...
9. [Empty]
    ...
    a. By January 31st of each year, each seizing agency shall remit to the state  an amount equal to ten percent of the net proceeds of any property forfeited during the preceding calendar year **for deposit into the behavioral health loan repayment program account created in RCW 28B.115.135 through June 30, 2027, and into the state general fund thereafter**.
...
## Section 2
> This section modifies existing section [46.61.5058](/rcw/46_motor_vehicles/46.61_rules_of_the_road.md). Here is the [modified chapter](rcw/46_motor_vehicles/46.61_rules_of_the_road.md) for context.
...
## Section 3
> This section modifies existing section [10.105.010](/rcw/10_criminal_procedure/10.105_property_involved_in_a_felony.md). Here is the [modified chapter](rcw/10_criminal_procedure/10.105_property_involved_in_a_felony.md) for context.
...
7. By January 31st of each year, each seizing agency shall remit to the state  an amount equal to ten percent of the net proceeds of any property forfeited during the preceding calendar year**for deposit into the behavioral health loan repayment program account created in RCW 28B.115.135 through June 30, 2027, and into the state general fund thereafter**.
    ...
    c. Retained property and net proceeds not required to be **remitted** to the state , or otherwise required to be spent under this section, shall be retained by the seizing law enforcement agency exclusively for the expansion and improvement of law enforcement activity. Money retained under this section may not be used to supplant preexisting funding sources.


## Section 4
> This section modifies existing section [9.68A.120](/rcw/09_crimes_and_punishments/9.068A_sexual_exploitation_of_children.md). Here is the [modified chapter](rcw/09_crimes_and_punishments/9.068A_sexual_exploitation_of_children.md) for context.
...
## Section 5
> This section modifies existing section [9A.88.150](/rcw/09A_washington_criminal_code/9A.88_indecent_exposure—prostitution.md). Here is the [modified chapter](rcw/09A_washington_criminal_code/9A.88_indecent_exposure—prostitution.md) for context.
