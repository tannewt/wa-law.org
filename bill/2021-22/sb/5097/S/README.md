...
## Section 2
> This section modifies existing section [50A.30.010](/rcw/50A_family_and_medical_leave/50A.30_voluntary_plans.md). Here is the [modified chapter](rcw/50A_family_and_medical_leave/50A.30_voluntary_plans.md) for context.
...
5. The commissioner must approve any voluntary plan as to which the commissioner finds that there is at least one employee in employment and all of the following exist:
    ...
    h. The voluntary plan provides that an employee of an employer with a voluntary plan for either family leave or medical leave, or both, who takes leave under the voluntary plan is entitled to the employment protection provisions contained in RCW 50A.35.010 if the employee has worked for the employer for at least **90 days**.

    i. The voluntary plan provides that the employer maintains the employee's existing health benefits **if the employee has worked for the employer for at least 90 days**.
