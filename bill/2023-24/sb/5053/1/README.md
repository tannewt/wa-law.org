...
5. [Empty]
    ...
    a. A residential insurance policy that contains sublimits shall include on the policy's declarations page a statement that the policy may limit the amount of coverage available for certain losses, and that the insured should review the policy carefully.

    b. For the purposes of this subsection (5) only:

        i. "Residential insurance policies" include all homeowners, renters, condominium, mobile home, and manufactured home personal insurance policies.

        ii. "Sublimit" means a limitation in a personal insurance policy on the limits of coverage available to cover certain losses that are lower than the overall policy limits.

    c. The entire declarations page must be delivered to the insured at every policy renewal.

    d. This subsection applies to residential insurance policies issued or renewed on or after January 1, 2024.

    e. This subsection shall not apply to policies issued pursuant to chapter 48.15 RCW.
