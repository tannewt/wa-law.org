...
7. Within the first 12 months after the effective date of this section, the department may test or pilot the verification system without taking any enforcement action under RCW 46.16A.130(2). By January 1, 2025, the verification system must be installed and fully operational.

8. For the purposes of this section, "NAIC" means national association of insurance commissioners.

## Section 2
1. The department may verify if a vehicle owner has liability insurance or other financial responsibility required under RCW 46.30.020 using the online motor vehicle insurance verification system established under section 1 of this act:

    a. At the time of original motor vehicle registration or registration renewal for vehicles subject to license fees under RCW 46.17.350(1) (a), (c), (d), (e), (g), (h), (j), (k), (n), (o), (p), and (q); and

    b. At least twice every year at random intervals for any vehicle owner with a previous violation of the requirements described in RCW 46.30.020 through 46.30.040 for a prior period as determined in rule.

2. If the online verification system provides that a vehicle owner does not have liability insurance or other financial responsibility under subsection (1)(a) of this section, the department may impose a penalty in the amount of $250 to be deposited into the driver licensing technology support account created in RCW 46.68.067.

3. The department must adopt any rules necessary to implement this section, including the process of imposing and collecting penalty amounts and the minimum number of violations required for random verifications of vehicle owner insurance coverage under subsection (1)(b) of this section.
...
## Section 6
By October 1, 2026, the department of licensing, after consultation with insurers, must report to the appropriate committees of the legislature the following concerning the verification system established in section 1 of this act:
